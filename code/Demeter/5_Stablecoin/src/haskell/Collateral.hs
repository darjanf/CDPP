...
stablecoinTokenName = TokenName $ encodeUtf8 "dUSD"
...
saveCollateralScript = writeValidatorToFile "./validators/collateral.plutus" validator

saveCollateralRedeem :: Prelude.IO ()
saveCollateralRedeem = writeDataToFile "./data/collateralRedeem.json" Redeem

saveCollateralLiquidate :: Prelude.IO ()
saveCollateralLiquidate = writeDataToFile "./data/collateralLiquidate.json" Liquidate

saveAll :: Prelude.IO ()
saveAll = do
            saveCollateralScript
            saveCollateralRedeem
            saveCollateralLiquidate