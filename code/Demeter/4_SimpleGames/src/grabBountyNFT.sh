...
tokenamount="50"
policyid=$(cat /workspace/code/Demeter/4_SimpleGames/validators/bountyNFT.policy)
...
validatorfile="/workspace/code/Demeter/4_SimpleGames/validators/bountyNFT.plutus"
nftmetadatafile="/workspace/code/Demeter/4_SimpleGames/data/bountyNFTMetadata.json"
redeemerfile="/workspace/code/Demeter/4_SimpleGames/data/unit.json"
paramsfile="/workspace/data/protocolparams.json"
txunsignedfile="/workspace/code/Demeter/4_SimpleGames/txoutputs/grabBountyNFT2.unsigned"
txsignedfile="/workspace/code/Demeter/4_SimpleGames/txoutputs/grabBountyNFT2.signed"
era="--babbage-era"
script="/workspace/code/Demeter/4_SimpleGames/validators/bountyNFT.plutus"
