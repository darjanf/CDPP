...
{-# INLINABLE handson0001#-}
handson0001 :: BuiltinData -> BuiltinData -> BuiltinData -> ()
handson0001 d r sc
  | d == r              = ()
  | r == mkI 11         = ()
  | otherwise           = error ()
...
handson0001Validator :: Validator
handson0001Validator = mkValidatorScript $$(PlutusTx.compile [|| handson0001 ||])
...
saveHandson0001 :: IO ()
saveHandson0001 = writeValidatorToFile "./testnet/handson0001.plutus" handson0001Validator
