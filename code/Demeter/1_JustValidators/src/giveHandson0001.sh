utxoin="3efc54e82642c3affc354f85e733188ade31c2b3bfe724ecc5d9cbed0a311474#1"
contractaddress=$(cat /workspace/code/Demeter/1_JustValidators/testnet/handson0001.addr)
...
cardano-cli transaction build \
  ...
  --tx-out-datum-hash-file /workspace/code/Demeter/1_JustValidators/testnet/unit.json \
